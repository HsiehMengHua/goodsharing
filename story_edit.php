...
$sql = "SELECT `title`, `content` FROM `story` WHERE `id` = ".$_GET['id'];
...
<body>
  ...
  <div class="form">
    <div class="container">
      <form action="story_update.php?id=<?php echo $_GET['id']; ?>" method="post">
        <ul>
          <li>
            <label>故事標題
          ...
          <li class="editor">編輯內容<br><br>
            <textarea name="editor"><?php echo $row['content']; ?></textarea>
