...
$err = "";
$account = (isset($_POST['account']))?input($_POST['account']):"";
$password = (isset($_POST['password']))?input($_POST['password']):"";

$sql = "SELECT id,account,password FROM `or_account` WHERE `account` = '$account' AND `password` = '$password'";
...
if($result->num_rows){
  ...
  $err = (empty($account) && empty($password))?"":"帳號或密碼輸入錯誤";
}
...
<body>
  ...
  <div class="form">
    <div class="container thin">
      <div class="toLogin"><a href="login.php">一般會員登入<span>&#10140;</span></a></div>
