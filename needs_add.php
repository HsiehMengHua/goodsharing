...
<body>
  ...
  <div class="form">
    <div class="container">
      <form action="needs_insert.php" method="post" class="clear">
        <div class="image">
        ...
        <ul class="content">
          ...
          <li>用途<br>
            <textarea name="usage" cols="30" rows="1" placeholder="說明此需求物品的使用目的" onkeyup="auto_grow(this)"></textarea>
          </li>
          <li class="clear">
            <button class="submit btn waves-effect waves-light orange accent-2" type="submit">送出</button>
